    ...
    <div className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-2">
      <div className="flex justify-between items-center mb-4">
        ...
        >
          ...
          <span className="sr-only">{isCollapsed ? 'Expand team' : 'Collapse team'}</span>
        </button>
      </div>
      ...
      <div
        ...
        className={`transition-all duration-300 ease-in-out overflow-hidden ${
          isCollapsed ? 'max-h-0 lg:max-h-full' : 'max-h-screen'
        }`}
      >
        <div
          className={`grid grid-cols-2 sm:grid-cols-3 gap-1 items-stretch mb-4 p-1 rounded-lg transition-all ${
